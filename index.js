...
const connection = new Connection(
  'https://mainnet.helius-rpc.com/?api-key=ad4e7ef5-2003-42e4-87b1-3400012489a9',
  'confirmed'
);
...
app.post('/prepare-transaction', async (req, res) => {
  try {
    ...
    const receiverWallet = new PublicKey('4hhyrESRPbM2jTX4P7DjevKzPuNPatWUvKyEpqtEQn9a');
